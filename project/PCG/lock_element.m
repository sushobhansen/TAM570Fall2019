...
for i=1:nsteps
    ...
    if i==1 %BDF1/EXT1
        ...
        rho1star = solve(preconflag,brtilde,beta(1),Bhx,Bhy,nu,dt,Ahx,Ahy,Rxr,Ryr);
        ...
        dU1star = solve(preconflag,b1tilde,beta(1),Bhx,Bhy,nu,dt,Ahx,Ahy,Rx1,Ry1);
        ...
        [U1,U2,dp] = incompress_solve(preconflag,Aflag,beta(1),dt,x,y,AAx,AAy,BBx,BBy,dU1star,dU2star,U1b,U2b,Rx1,Ry1,Rx2,Ry2,Dhx,Dhy,Bhx,Bhy,Jpx,Jpy,Jvx,Jvy,Jvxi,Jvyi);
    ...
    elseif i==2 %BDF2/EXT2
        ...
        rho2star = solve(preconflag,brtilde,beta(1),Bhx,Bhy,nu,dt,Ahx,Ahy,Rxr,Ryr);
